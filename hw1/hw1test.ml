...
(*For function subset:*)
let my_subset_test0 = subset [1;2] [2;1;3];;
let my_subset_test1 = subset [1;2] [1;2;1;3];;
let my_subset_test2 = not (subset [1;2] [1]);;

(* For equal_sets: *)

let my_equal_sets_test0 = equal_sets [3;1;4;4;4;4] [1;3;4];;
let my_equal_sets_test1 = not (equal_sets [1;3;4] [1;3]);;           
...
let my_set_intersection_test0 = equal_sets (set_intersection  [1;2;3;4] [1;1;2;2;5;5]) [1;2]
let my_set_intersection_test1 = equal_sets (set_intersection  [1;1;2;3;4;4;4] [1;4]) [1;4];;
...
let my_set_diff_test0 = equal_sets (set_diff [4;3;3;1;1;2] [1;2;3]) [4]
let my_set_diff_test1 = equal_sets (set_diff [4;3;3;1;1;2] [1;2]) [4;3] ;;


(* For set_union *)
let my_set_union_test0 = equal_sets (set_union [1;1;5;5] [5;1;6]) [1;5;6]
let my_set_union_test1 = equal_sets (set_union [1;4;5;0] []) [1;5;4;0];; 

(*For computed_fixed_point_test*)
...
(*any consine function coverges to 0.739085133 *)
let my_computed_fixed_point_test0 = (0.739085133 -. computed_fixed_point (fun x y -> abs_float (x -. y) < 0.00000001) (fun x -> cos x) 2.) < 0.0000001;;


(*For computed_periodic_point *)
...
let awksub_test2 = filter_blind_alleys (Expr, List.tl (List.tl awksub_rules)) =
	(Expr,
	[Incrop, [T "++"];
	Incrop, [T "--"];
	Binop, [T "+"];
